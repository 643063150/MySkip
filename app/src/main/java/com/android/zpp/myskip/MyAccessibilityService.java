 ...
 * @Description:
 * @Author: zpp
 * @CreateDate: 2022/5/30 11:23
 * @UpdateUser:
 * @UpdateDate: 2022/5/30 11:23
 * @UpdateRemark:
 */
public class MyAccessibilityService extends AccessibilityService {
    public static MyAccessibilityService mService;
    public static String TAG="跳过";
        ...
        try {
            ...
            switch (eventType){
                case AccessibilityEvent.TYPE_WINDOW_CONTENT_CHANGED:
                    Log.e(TAG,event.getSource().getPackageName().toString());
                    AccessibilityNodeInfo accessibilityNodeInfo=findFirst(AbstractTF.newText("跳过", false));
                    if (accessibilityNodeInfo!=null){
                        Log.e(TAG,"ssssssssss");
                        dispatchGestureClick(accessibilityNodeInfo);
                    }
                    break;
                default:
                    break;
    ...
    public void onInterrupt() {
        Toast.makeText(mService,"辅助功能已断开",Toast.LENGTH_SHORT).show();
        mService = null;
    }
    ...
    public static void recycleAccessibilityNodeInfo(List<AccessibilityNodeInfo> listInfo) {
        if (Utils.isEmptyArray(listInfo)) {
            return;
        }
